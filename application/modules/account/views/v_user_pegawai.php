                        ...
                        <form method="get" action="<?= base_url()?>account/akun_pegawai" >
                            <div class="form-group">
                                ...
                                <select class="form-control select2" name="satuan" style="width: 100%;">
                                    ...
                                    <option value="<?= $rows->id_satuan ?>" <?php if($rows->id_satuan==$this->input->get('satuan')){echo"selected"; } ?>><?= $rows->nm_satuan ?></option>
                                    <?php }?>
                                </select>
                            </div>
                            <div class="card-footer">
                                <button type="submit" name="subject" class="btn btn-sm btn-info" value="tampildata"><i class="fas fa-eye"></i> Tampilkan Data</button>
