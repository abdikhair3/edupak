          ...
          <div class="col-12">
            ...
            <div class="card">
              ...
              <div class="col-6">
                ...
                <tbody>
                 <?php $no=1; foreach ($unsur as $rows) { ?>
                            <tr align="center">
                              ...
                              <td>
                                <a href="<?= base_url()?>kegiatan/sub_sub_unsur/tp/<?= $rows->id_sub_unsur ?>" title="Tambah Unsur Kegiatan / Tugas" type="button" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></a>
                                <a href="<?= base_url()?>kegiatan/subunsur/tp/<?= $rows->id_unsur ?>/<?= $rows->id_sub_unsur ?>" title="Edit Data" type="button" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
                                <a href="<?= base_url()?>kegiatan/<?= $rows->id_unsur ?>" title="Hapus Data" type="button" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                              </td>
                            </tr>
                  <?php $no++;  } ?>
                </tbody>
                ...
                <a href="../../<?php base_url()?>unsur/tp/<?php echo $this->uri->segment(4); ?>" class="btn btn btn-warning btn-sm">Kembali <br>
              ...
              <div class="col-6">
                <form class="form-horizontal" action="<?php if($this->uri->segment(5)!=null) { echo base_url()."kegiatan/subunsur/edit_unsur"; } else { echo base_url()."kegiatan/subunsur/tambah_unsur"; } ?>" method="post">
